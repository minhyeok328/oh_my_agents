...
Use this file when `oh_my_agents` is acting as the governance shell for one or more user Git projects under `workspaces/`.

## Model

`oh_my_agents` is the governance shell.
